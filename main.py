...
if __name__ == '__main__':
    ...
    greeting_message = """Welcome to Poke4J!
...
"""
    ...
    if filter_option == '5':
        result = execute_query(query, {"min_height": user_input[0], "max_height": user_input[1]})
    else:
        result = execute_query(query, {"input": user_input})
